...
Much of the motivation behind this project is, as outlined in Section 
\ref{sec:problem-formulation}, to develop models that can predict activations
...
\subsection{Cross-zonal flow features}
