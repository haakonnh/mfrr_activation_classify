...
wind power, has fundamentally altered the dynamic behavior of modern
power systems. Unlike conventional synchronous generation, these resources
contribute little or no rotational inertia, reducing the system's ability to
passively resist frequency deviations following disturbances. As a result,
frequency deviations now evolve more rapidly and with greater amplitude, making
short-term system imbalances both more frequent and more difficult to predict
...
operating at a 15-minute resolution \autocite{ConfirmationMFRREAM2025}. This
...
%balancing resources, among which manual Frequency Restoration Reserves (mFRR)
%play a key role. The mFRR energy activation market (mFRR EAM) enables market
%participants to offer up- and down-regulation reserves that the TSO can activate
%when sustained imbalances occur \autocite{entso-eNoricBalancingPhilosophy2024}.
