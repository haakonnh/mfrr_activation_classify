...
\autocite{caiLowInertiaPower2023}.
...
\textbf{handling uncertainty importanf for further work, near real tiem, continuous}
...
The remainder of this report is structured as follows: Section 2 provides an overview 
of the Nordic balancing markets and related work. Section 3 formulates the prediction 
problem and presents the dataset. Section 4 details the modelling methodology, including 
feature engineering and model selection. Section 5 presents the results and performance 
evaluation, while Section 6 discusses implications, limitations, and directions for future work
