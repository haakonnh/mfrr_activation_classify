...
\textbf{Figure is a stand-in. I was thinking of including a flow chart of some
kind here to introduce the workflow/approach to the project in this section.}
\begin{itemize}
    \item Data collection from various sources (Nord Pool, NUCS, ENTSO-E)
...
\begin{figure}[H]
    \centering
    \includegraphics[width=\textwidth]{Images/Business-processes-Cross-Functional-Flowcharts-Trading-process-Sample.png}
...
\paragraph{aFRR procurement prices and volumes data}
is difficult to obtain. However, through the NUCS API,
...
values for up- and down-regulation. This data provides some insights into the amount 
...
\subsubsection{Alignment, Resampling, and Merging}

\subsubsection{Handling Missing Data}

\subsubsection{Exploratory Data Analysis}

\paragraph{Activation Class Distribution.}
Figure 
...
\paragraph{Lag Features/Information Availability}