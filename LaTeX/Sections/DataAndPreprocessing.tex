...
activations over the dataset period. The figure especially highlights the
infrequent nature of up-activations, which occur far less often than
down-activations. This class imbalance is a critical consideration for the
...
formulation adopted in this project makes zero-volume intervals a discrete target 
class, reducing noise from volume magnitude variations within activation classes.
\textbf{I like this, but does it fit here or in discussion? Perhaps both.}


\begin{figure}[H]
    \centering
    \includegraphics[width=0.7\textwidth]{Images/mfrr_distribution.png}
...
The data appears complete after this date. 
\begin{figure}[H]
    \centering
