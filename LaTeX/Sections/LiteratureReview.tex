...
continue to increase \autocite{BalancingMarketOutlook}. The report also suggests
...
\autocite{azarangMachineLearningBasedPrediction}. The results reveal strong
...
\autocite{bankeforsDayaheadModellingElectricity}. The study concludes that while
...
In a 2023 study, it is argued that deterministic reserve activation models
inaccurately represent activation uncertainty. Thus, a stochastic model is
presented, but more interestingly, a robust electric vehicle aggregator
scheduling model using uncertain bounded activation ranges is proposed
...
\begin{tabular}{p{3.0cm} p{1.2cm} p{3.0cm} p{1.8cm} p{3.6cm}}
\toprule
...
\midrule
\autocite{azarangMachineLearningBasedPrediction} & 2025 & mFRR activation volume & 1-hour & ML point forecast (LSTM) \\
\midrule
...
\midrule
\autocite{bankeforsDayaheadModellingElectricity} & 2024 & Signed activation volume & 1-hour & Linear ML time-series; implicit direction \\
\midrule
