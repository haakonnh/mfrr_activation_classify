...
Example:
	python mfrr_classify\\scripts\\preprocess_cache.py --area NO1 --out mfrr_classify\\data\\preprocessed\\df_NO1.pkl

Then train using:
	python mfrr_classify\\src\\train\\train.py --task multiclass --preprocessed_path mfrr_classify\\data\\preprocessed\\df_NO1.pkl
"""
...
def parse_args() -> argparse.Namespace:
	...
	p.add_argument(
		"--data_dir",
		type=str,
		default=str(Path("mfrr_classify") / "data" / "raw"),
	...
	p.add_argument(
		...
		type=str,
		required=True,
		help="Output cache path (pickle), e.g. mfrr_classify\\data\\preprocessed\\df_NO1.pkl",
	)
