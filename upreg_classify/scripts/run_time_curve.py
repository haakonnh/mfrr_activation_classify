...
def build_parser() -> argparse.ArgumentParser:
    p = argparse.ArgumentParser(
        description=(
            "Run time-curve experiments by invoking upreg_classify/src/models/train.py "
    ...
    p.add_argument(
        "--logs-dir",
        type=str,
        default=str(Path("upreg_classify") / "models" / "time_curve_logs"),
        help="Directory to write per-budget logs (stdout/stderr).",
    )
    p.add_argument(
        "--runs-dir",
        type=str,
        default=str(Path("upreg_classify") / "models" / "time_curve_runs"),
...
def main():
    ...
    train_py = repo_root / "upreg_classify" / "src" / "models" / "train.py"
